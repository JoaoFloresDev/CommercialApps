...
class CheckoutRepeat extends StatefulWidget {
  @override
  _CheckoutRepeatState createState() => _CheckoutRepeatState();
}

class _CheckoutRepeatState extends State<CheckoutRepeat> {
  ...
  Future load() async {
    var prefs = await SharedPreferences.getInstance();
    var data = prefs.getString('dataRepeat');
    if(data != null) {
